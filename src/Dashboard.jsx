...
<body>
  ...
  <div class="header">
    <div>
      <div class="logo"><span>C</span>RM</div>
  ...
  <div class="footer">
    <strong>CRM</strong> · Report generated by CRM Dashboard
  </div>
</body>
</html>`;
  ...
  return (
    <div style={{ fontFamily: "'DM Sans', Helvetica, sans-serif", background: B.bg, minHeight: "100vh", color: B.castIron }}>
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 24 }}>
            <div>
              <span style={{ fontWeight: 900, fontSize: 22, letterSpacing: -1, color: B.white }}>
                <span style={{ color: B.carrot }}>C</span>RM
              </span>
      ...
      <div style={{ textAlign: "center", padding: "20px 32px 32px", fontSize: 12, color: B.stoneLight }}>
        <span style={{ color: B.carrot, fontWeight: 700 }}>CRM</span> Dashboard
      </div>
    </div>
  );
}
